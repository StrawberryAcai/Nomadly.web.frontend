...
import Bg from "@public/backgrounds/button2x.svg";
import AI from "@public/icons/button/AI.svg";

const AiScheduleButton: React.FC = () => {
  return (
    <SectionContainer className="h-32">
      <Link href="/schedule" className="w-full h-full relative bg-center rounded-xl px-3 py-8" style={{ backgroundImage: `url(${Bg.src})`, backgroundSize: "cover" }}>
