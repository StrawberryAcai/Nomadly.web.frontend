...
const NavBar: React.FC = () => (
  <nav className="px-4 flex justify-around">
    ...
    <CustomLink href="/src/app/(page)/(with-nav)/profile/(with-nav)/bookmark/plans">북마크한 일정</CustomLink>
    <CustomLink href="/src/app/(page)/(with-nav)/profile/(with-nav)/bookmark/places">북마크한 장소</CustomLink>
